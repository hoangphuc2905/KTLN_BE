    ...
    try {
      ...
      if (!scientificPapers || scientificPapers.length === 0) {
        return res.status(404).json({
          message: academicYear ? `No approved scientific papers found for academic year ${academicYear}` : "No approved scientific papers found"
        });
      }
      res.status(200).json({
        message: academicYear ? `Approved scientific papers for academic year ${academicYear}` : "All approved scientific papers retrieved successfully",
