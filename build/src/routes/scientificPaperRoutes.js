 ...
 */
router.get("/top5-newest", scientificPaperController.getTop5NewestScientificPapers);
 ...
 *         description: Internal server error
 */
router.get("/top5-most-viewed-downloaded", scientificPaperController.getTop5MostViewedAndDownloadedPapers);
 ...
 *         description: Server error
 */
router.get("/author/:userId", scientificPaperController.getScientificPapersByAuthorId);
 ...
 *         description: Server error
 */
router.get("/department/:department", scientificPaperController.getScientificPapersByDepartment);
 ...
 *         description: Server error
 */
router.put("/status/:id", scientificPaperController.updateScientificPaperStatus);
